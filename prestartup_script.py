...
def setup():
    handler = RotatingFileHandler('comflow.log', maxBytes=500000, backupCount=5)
...
try:
    ...
    print(f"** Comflow Revision: {current_git_commit}")
except Exception as e:
    print(f"** Comflow failed to get current git commit: {str(e)}")
finally:
