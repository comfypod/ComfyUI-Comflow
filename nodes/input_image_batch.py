...
NODE_CLASS_MAPPINGS = {"ComflowInputImageBatch": ComflowInputImageBatch}
NODE_DISPLAY_NAME_MAPPINGS = {"ComflowInputImageBatch": "Input Image Batch (Comflow)"}