...
class ComflowWebsocketImageInput:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {"ComflowWebsocketImageInput": ComflowWebsocketImageInput}
NODE_DISPLAY_NAME_MAPPINGS = {"ComflowWebsocketImageInput": "Image Websocket Input (Comflow)"}