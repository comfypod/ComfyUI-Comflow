...
NODE_CLASS_MAPPINGS = {"ComflowInputImageAlpha": ComflowInputImageAlpha}
NODE_DISPLAY_NAME_MAPPINGS = {"ComflowInputImageAlpha": "Input Image Alpha (Comflow)"}