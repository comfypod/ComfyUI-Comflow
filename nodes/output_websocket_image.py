...
class ComflowWebsocketImageOutput:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {"ComflowWebsocketImageOutput": ComflowWebsocketImageOutput}
NODE_DISPLAY_NAME_MAPPINGS = {"ComflowWebsocketImageOutput": "Image Websocket Output (Comflow)"}