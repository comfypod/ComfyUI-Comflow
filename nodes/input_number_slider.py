class ComflowInputNumberSlider:
    @classmethod
    def INPUT_TYPES(s):
        return {
            "required": {
...
NODE_CLASS_MAPPINGS = {"ComflowInputNumberSlider": ComflowInputNumberSlider}
NODE_DISPLAY_NAME_MAPPINGS = {"ComflowInputNumberSlider": "Input Number Slider (Comflow)"}